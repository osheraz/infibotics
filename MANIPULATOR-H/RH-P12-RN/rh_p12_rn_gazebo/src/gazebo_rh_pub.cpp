...
int main(int argc, char **argv)
{
  ...
  g_rh_r2_joint_pub = nh.advertise<std_msgs::Float64>("/robotis_manipulator_h/rh_r2_position/command", 0);
  g_rh_l1_joint_pub = nh.advertise<std_msgs::Float64>("/robotis_manipulator_h/rh_l1_position/command", 0);
  g_rh_l2_joint_pub = nh.advertise<std_msgs::Float64>("/robotis_manipulator_h/rh_l2_position/command", 0);

  ros::Subscriber rh_joint_sub = nh.subscribe("/robotis_manipulator_h/rh_p12_rn_position/command", 5, rhJointCallback);
