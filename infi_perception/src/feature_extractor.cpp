...
#include <infi_perception/GetNormals.h>
//#include <infi_perception/GetFloatArrayFeature.h>
...
private:
  ...
  bool getNormalsReq(infi_perception::GetNormals::Request &req, infi_perception::GetNormals::Response &rsp)
  {
...
// bool getVFHReq(infi_perception::GetNormals::Request &req, infi_perception::GetNormals::Response &rsp)
// {
//   pcl::PointCloud<pcl::PointXYZ> *p_cloud = new pcl::PointCloud<pcl::PointXYZ>();
//   const boost::shared_ptr<pcl::PointCloud<pcl::PointXYZ> > sp_pcl_cloud(p_cloud);
//   pcl::fromROSMsg(req.cluster, *p_cloud);
